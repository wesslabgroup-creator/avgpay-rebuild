...
export function PercentileCalculator() {
  ...
  return (
    <Card className="bg-surface border-border">
      <CardHeader>
        <CardTitle className="text-2xl text-text-primary">Calculate Your Percentile</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Input Form */}
        <div className="space-y-4">
          <div>
            <Label htmlFor="salary" className="text-text-secondary">Your Total Compensation</Label>
            <Input
              id="salary"
              type="text"
              placeholder="$150,000"
          ...
          <div>
            <Label htmlFor="role" className="text-text-secondary">Your Role</Label>
          ...
          <div className="mt-8 pt-8 border-t border-border space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="text-center p-4 bg-surface-subtle rounded-lg">
                <div className="text-2xl font-bold text-text-primary">{result.belowYou}%</div>
                <div className="text-xs text-text-secondary mt-1">Earn Less</div>
              </div>
              <div className="text-center p-4 bg-primary-subtle rounded-lg">
                ...
                <div className="text-xs text-text-secondary mt-1">Median Salary</div>
              </div>
              <div className="text-center p-4 bg-surface-subtle rounded-lg">
                <div className="text-2xl font-bold text-text-primary">{result.aboveYou}%</div>
                <div className="text-xs text-text-secondary mt-1">Earn More</div>
              </div>
            </div>

            {/* Percentile Bar */}
            <div className="space-y-2">
              <div className="text-sm font-medium text-text-secondary">Your Position</div>
              <div className="relative h-8 bg-gradient-to-r from-red-500 via-yellow-500 via-emerald-400 to-emerald-600 rounded-full overflow-hidden">
                <div
                  className="absolute top-0 h-full w-1 bg-secondary"
