            ...
            <div className="bg-surface border-b border-border">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-subtle text-primary-hover text-sm font-medium mb-6">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-text-primary tracking-tight leading-tight mb-6">
                            ...
                            <span className="text-primary">Your Raise?</span>
                        </h1>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 space-y-12">
                ...
                <div className="grid md:grid-cols-3 gap-8 text-center">
                    <div className="p-6 bg-surface rounded-xl border border-border shadow-sm">
                        ...
                        <h3 className="font-bold text-text-primary">CPI Data Source</h3>
                        <p className="text-sm text-text-secondary mt-2">Uses official BLS Consumer Price Index (CPI-U) data.</p>
                    </div>
                    <div className="p-6 bg-surface rounded-xl border border-border shadow-sm">
                        <DollarSign className="w-10 h-10 text-primary mx-auto mb-4" />
                        <h3 className="font-bold text-text-primary">Real Wage Growth</h3>
                        <p className="text-sm text-text-secondary mt-2">Calculates if your purchasing power has actually increased.</p>
                    </div>
                    <div className="p-6 bg-surface rounded-xl border border-border shadow-sm">
                        <Calculator className="w-10 h-10 text-primary mx-auto mb-4" />
                        <h3 className="font-bold text-text-primary">Negotiation Ready</h3>
                        <p className="text-sm text-text-secondary mt-2">Get the exact number you need to ask for to break even.</p>
                    </div>
                </div>
                ...
                <div className="bg-secondary rounded-3xl p-8 sm:p-12 text-center text-text-inverse relative overflow-hidden">
                    <div className="relative z-10 space-y-6">
                        ...
                        <Link href="/analyze-offer" className="inline-flex items-center gap-2 bg-primary-subtle0 hover:bg-primary text-text-inverse font-bold px-8 py-4 rounded-xl transition-all transform hover:scale-105">
                            Analyze My Salary <ArrowRight className="w-5 h-5" />
                        </Link>
                    </div>

                    {/* Decorative background elements */}
                    <div className="absolute top-0 right-0 w-64 h-64 bg-primary-subtle0/10 rounded-full blur-3xl -mr-32 -mt-32"></div>
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-info-subtle rounded-full blur-3xl -ml-32 -mb-32"></div>
                </div>
