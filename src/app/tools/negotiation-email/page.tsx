        ...
        <main className="min-h-screen bg-surface-subtle py-12 px-4 sm:px-6">
            <div className="max-w-5xl mx-auto space-y-8">
                <div className="text-center space-y-4">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-subtle text-success-foreground text-sm font-medium">
                    ...
                    <p className="text-xl text-text-secondary max-w-2xl mx-auto">
                        ...
                        <span className="font-semibold text-primary"> real market data</span> and proven strategies.
                    </p>
                </div>

                <EmailGenerator />

                <div className="max-w-3xl mx-auto pt-12 prose text-text-secondary">
                    <h2 className="text-text-primary">Why negotiate?</h2>
                    <p>
                    ...
                    <h3 className="text-text-primary">Tips for success:</h3>
                    <ul>
