              ...
              <div className="flex flex-wrap gap-2">
                {relatedJobs.map(job => (
                  <Link
                    ...
                    className="inline-flex items-center justify-center h-9 px-3 rounded-md border border-slate-300 bg-white text-sm font-medium text-slate-800 transition-colors hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
                  >
                    {job.title}
                  </Link>
                ))}
