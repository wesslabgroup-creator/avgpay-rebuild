    ...
    <main className="min-h-screen">
      ...
      <section className="px-6 py-16 bg-slate-900/30 border-y border-slate-800">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold">The Salary Negotiation is Broken</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-lg">Problem: No Data</h3>
            ...
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-lg">Agitation: Outdated Info</h3>
              <p className="text-slate-400">
            ...
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-lg">Solution: Verified Data</h3>
              <p className="text-slate-400">
      ...
      <section className="px-6 py-16 bg-slate-900/30 border-y border-slate-800">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-2xl font-bold">Data You Can Trust</h2>
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="p-6 rounded-lg bg-slate-800/50 border border-slate-700">
              <Database className="w-8 h-8 text-indigo-400 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">BLS Data</h3>
            ...
            <div className="p-6 rounded-lg bg-slate-800/50 border border-slate-700">
              ...
              <h3 className="font-semibold mb-2">H-1B Filings</h3>
            ...
            <div className="p-6 rounded-lg bg-slate-800/50 border border-slate-700">
              ...
              <h3 className="font-semibold mb-2">Pay Transparency</h3>
