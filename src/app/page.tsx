    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative max-w-6xl mx-auto text-center space-y-8 lg:space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
            ...
            <Link href="/salaries" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg px-8 py-7 border-2 border-slate-700/50 hover:border-indigo-500/50 bg-white backdrop-blur-sm hover:bg-slate-800/50 text-slate-300 hover:text-white rounded-2xl h-14 sm:h-auto font-semibold transition-all duration-300">
                Browse Salaries
              </Button>
            </Link>
          </div>
      ...
      <section className="px-4 py-20 md:py-24 bg-slate-900/30 border-y border-slate-200/50 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto space-y-12 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div className="bg-white backdrop-blur-sm border border-slate-200/50 p-8 rounded-3xl hover:shadow-2xl hover:shadow-indigo-500/10 hover:border-indigo-500/30 transition-all duration-500 group space-y-6">
            ...
            <div className="bg-white backdrop-blur-sm border border-slate-200/50 p-8 rounded-3xl hover:shadow-2xl hover:shadow-violet-500/10 hover:border-violet-500/30 transition-all duration-500 group space-y-6 md:col-span-2 lg:col-span-1">
              <div className="flex gap-3 text-emerald-400 text-xl">
                <Star className="w-6 h-6 fill-current" />
                <Star className="w-6 h-6 fill-current" />
                <Star className="w-6 h-6 fill-current" />
      ...
      <section className="px-4 py-20 md:py-24 lg:py-32 bg-white/50">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <div className="border border-slate-200/50 rounded-2xl overflow-hidden backdrop-blur-sm bg-slate-900/30 hover:border-indigo-500/50 transition-all duration-300">
      ...
      {/* Final CTA */}
      <section className="px-4 py-20 md:py-24 text-center bg-gradient-to-b from-indigo-900/40 to-slate-950/80 border-y border-slate-200/50">
